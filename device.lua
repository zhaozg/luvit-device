...
exports.homepage = "https://github.com/zhaozg/luvit-device/blob/master/device.lua"
...
function Device:read(onData)
  ...
  self.onRead = onRead
  return uv.read_start(self._handle, onRead)
end

function Device:ioctl(cmd, ...)
  return uv.device_ioctl(self._handle, cmd, ...)
end
